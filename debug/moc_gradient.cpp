...
struct qt_meta_stringdata_Gradient_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Gradient_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Gradient_t qt_meta_stringdata_Gradient = {
    {
QT_MOC_LITERAL(0, 0, 8) // "Gradient"
...
const QMetaObject Gradient::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Gradient.data,
      qt_meta_data_Gradient,  qt_static_metacall, nullptr, nullptr}
};
...
void *Gradient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Gradient.stringdata0))
